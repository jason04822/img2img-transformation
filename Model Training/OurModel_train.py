...
class Generator(nn.Module):
    ...
    def __init__(self):
        ...
        self.up1 = nn.Sequential(nn.ConvTranspose2d(512,512,4,2,1), nn.BatchNorm2d(512), nn.ReLU(), nn.Dropout(0.5))
        self.up2 = nn.Sequential(nn.ConvTranspose2d(1024,256,4,2,1), nn.BatchNorm2d(256), nn.ReLU(), nn.Dropout(0.5))
...
class Discriminator(nn.Module):
    ...
    def forward(self, real, pixel):
        pixel = F.interpolate(pixel, size=(128,128), mode='nearest')
